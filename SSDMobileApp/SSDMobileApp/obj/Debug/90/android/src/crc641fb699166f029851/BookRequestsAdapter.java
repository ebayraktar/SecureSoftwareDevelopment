...
public class BookRequestsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SSDMobileApp.Adapters.BookRequestsAdapter, SSDMobileApp", BookRequestsAdapter.class, __md_methods);
	}


	public BookRequestsAdapter ()
	{
		super ();
		if (getClass () == BookRequestsAdapter.class)
			mono.android.TypeManager.Activate ("SSDMobileApp.Adapters.BookRequestsAdapter, SSDMobileApp", "", this, new java.lang.Object[] {  });
	}
