...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SSDMobileApp.Adapters.RequestsAdapter, SSDMobileApp", RequestsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == RequestsAdapter.class)
			mono.android.TypeManager.Activate ("SSDMobileApp.Adapters.RequestsAdapter, SSDMobileApp", "", this, new java.lang.Object[] {  });
	}
