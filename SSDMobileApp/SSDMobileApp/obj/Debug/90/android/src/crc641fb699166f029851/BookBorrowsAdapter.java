...
public class BookBorrowsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SSDMobileApp.Adapters.BookBorrowsAdapter, SSDMobileApp", BookBorrowsAdapter.class, __md_methods);
	}


	public BookBorrowsAdapter ()
	{
		super ();
		if (getClass () == BookBorrowsAdapter.class)
			mono.android.TypeManager.Activate ("SSDMobileApp.Adapters.BookBorrowsAdapter, SSDMobileApp", "", this, new java.lang.Object[] {  });
	}
