...
public class UserAuthoritiesAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SSDMobileApp.Adapters.UserAuthoritiesAdapter, SSDMobileApp", UserAuthoritiesAdapter.class, __md_methods);
	}


	public UserAuthoritiesAdapter ()
	{
		super ();
		if (getClass () == UserAuthoritiesAdapter.class)
			mono.android.TypeManager.Activate ("SSDMobileApp.Adapters.UserAuthoritiesAdapter, SSDMobileApp", "", this, new java.lang.Object[] {  });
	}
